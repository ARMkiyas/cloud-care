...
export default function page() {
  ...
  return (
    <>
      <div
        className="flex p-5 rounded-md shadow-lg"
          ...
          <div className="flex-none">
            ...
            <div>
              ...
              <div className="p-3 pr-5">
                {!editing ? (
                  <Button
                    className="w-full text-gray-600 border-black bg-slate-200"
                  ...
                  <>
                    ...
                    <Button className="w-full mt-2" onClick={handleCancelClick}>
                      Cancel
                    </Button>
                  </>
                )}
            ...
            <Table horizontalSpacing="lg" verticalSpacing="md">
              <Table.Tbody>
                ...
                <Table.Tr>
                  ...
                  <Table.Td>
                    {session.user.twoFactorEnabled ? "True" : "False"}
                  </Table.Td>
                </Table.Tr>
                <Table.Tr>
                  <Table.Td>
                ...
                <Table.Tr>
                  ...
                  <Table.Td>
                    <Button
                      className="text-gray-800 bg-yellow-200"
